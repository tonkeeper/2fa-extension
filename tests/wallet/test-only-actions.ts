...
import { ExtendedAction, OutAction } from './wallet_v5_actions';
...
export class ActionReserveCurrency {
    ...
    constructor(
        ...
        public readonly currency: CurrencyCollection,
    ) {}
...
export function isTestOnlyExtendedAction(action: OutAction | ExtendedAction): action is ExtendedAction {
    return action.tag === ActionSetData.tag;
}
